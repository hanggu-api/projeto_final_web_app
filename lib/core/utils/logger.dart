...
class AppLogger {
  ...
  static void erro(String message, [dynamic details]) => 
      _print('❌', 'ERRO', details != null ? '$message | Detalhe: $details' : message);
  ...
  static void notificacao(String message) => _print('🔔', 'NOTIFICAÇÃO', message);
