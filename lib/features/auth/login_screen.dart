...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleGoogleLogin() async {
    ...
    try {
      const webClientId = '478559853980-bd63tr459gslb0ish8t53c4e7gehjmi9.apps.googleusercontent.com';
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        if (didPop) return;
        if (_isLoginForm) setState(() => _isLoginForm = false);
      },
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          decoration: AppTheme.inputDecoration('Email', LucideIcons.mail).copyWith(
            enabledBorder: _hasError ? OutlineInputBorder(
        ...
        TextField(
          ...
          decoration: AppTheme.inputDecoration('Senha', LucideIcons.lock).copyWith(
        ...
        if (_hasError && _errorMessage != null) ...[
          ...
          Text(
            _errorMessage!,
            style: GoogleFonts.manrope(color: Colors.red, fontWeight: FontWeight.w600, fontSize: 13),
          ),
        ],
        const SizedBox(height: 32),
        SizedBox(
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            ...
            child: Row(
              ...
              children: [
                Image.asset('assets/images/google_logo.png', height: 20, errorBuilder: (c, e, s) => const Icon(Icons.login)),
                const SizedBox(width: 12),
                Text(
      ...
      child: Container(
        ...
        child: isFullWidth ? Row(
          children: [
            ...
            Text(
              label,
              style: GoogleFonts.manrope(fontWeight: FontWeight.w800, fontSize: 16, color: AppTheme.textDark),
            ),
            const Spacer(),
          ...
          children: [
            ...
            Text(
              label,
              style: GoogleFonts.manrope(fontWeight: FontWeight.w800, fontSize: 15, color: AppTheme.textDark),
            ),
          ],
        ),
      ),
