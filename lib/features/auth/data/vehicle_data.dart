...
class VehicleData {
  ...
  static const Map<String, List<String>> carBrands = {
    ...
    'Honda': ['Civic', 'City', 'HR-V', 'CR-V', 'Fit', 'WR-V', 'ZR-V', 'Accord'],
    'Renault': [
      'Kwid',
      'Sandero',
      'Logan',
    ...
    'Nissan': ['Kicks', 'Versa', 'Sentra', 'March', 'Frontier', 'X-Trail'],
    'Jeep': ['Renegade', 'Compass', 'Commander', 'Gladiator', 'Wrangler'],
    'Citroën': ['C3', 'C4 Cactus', 'Aircross', 'C3 Aircross', 'Berlingo'],
    'Peugeot': ['208', '2008', '3008', '308', '408'],
    'Kia': ['Sportage', 'Cerato', 'Seltos', 'Stonic', 'Carnival'],
    'Mitsubishi': ['L200', 'Outlander', 'Eclipse Cross', 'ASX', 'Pajero'],
    'Caoa Chery': [
      'Tiggo 2',
      'Tiggo 3X',
      'Tiggo 5X',
    ...
    'BYD': ['Dolphin', 'Yuan Plus', 'Song Plus', 'Han', 'Tan', 'Seal'],
    'GWM': ['Haval H6', 'Ora 03'],
  };
  ...
  static const Map<String, List<String>> motoBrands = {
    ...
    'Shineray': ['Jet 125', 'Worker 150', 'Phoenix 50'],
  };
