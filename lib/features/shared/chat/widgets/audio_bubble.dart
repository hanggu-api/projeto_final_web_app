      ...
      if (_playing) {
        ...
        if (_player.state == PlayerState.paused) {
          ...
          if (widget.mediaKey.startsWith('http')) {
            ...
            final file = File('${tempDir.path}/audio_${widget.mediaKey.hashCode}.m4a');
      ...
      child: Row(
        children: [
          GestureDetector(
            ...
            child: Container(
              width: 44, height: 44,
              decoration: BoxDecoration(color: accentColor, shape: BoxShape.circle, boxShadow: [BoxShadow(color: Colors.black12, blurRadius: 4, offset: const Offset(0, 2))]),
              child: _loadingUrl
                  ? const Padding(padding: EdgeInsets.all(12), child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white))
                  : Icon(_playing ? LucideIcons.pause : LucideIcons.play, color: Colors.white, size: 24),
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  height: 20,
                  child: SliderTheme(
                    data: SliderTheme.of(context).copyWith(thumbShape: const RoundSliderThumbShape(enabledThumbRadius: 6), overlayShape: const RoundSliderOverlayShape(overlayRadius: 14), trackHeight: 3, thumbColor: accentColor, activeTrackColor: accentColor, inactiveTrackColor: Colors.grey.withOpacity(0.3)),
                    child: Slider(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(_formatDuration(_position), style: TextStyle(color: fgColor.withOpacity(0.8), fontSize: 11, fontWeight: FontWeight.w500)),
                      Text(_formatDuration(_duration), style: TextStyle(color: fgColor.withOpacity(0.8), fontSize: 11, fontWeight: FontWeight.w500)),
                    ],
                  ),
                ),
              ],
